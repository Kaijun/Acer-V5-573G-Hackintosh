 ...
 * 
 * Disassembly of DSDT.aml, Fri May 16 03:06:08 2014
 *
    ...
    Scope (\_SB.PCI0.RP05.PEGP)
    {
        ...
        Method (_DSM, 4, Serialized)  // _DSM: Device-Specific Method
        {
                    ...
                    }))
            {
                While (One)
                {
                    Store (ToInteger (Arg2), _T_0) /* \_SB_.PCI0.RP05.PEGP._DSM._T_0 */
                    If (LEqual (_T_0, Zero))
                    {
                        Return (Buffer (0x04)
                        {
                        ...
                        Else
                        {
                            If (LEqual (_T_0, 0x10))
                            {
                                If (LEqual (Arg1, 0x0300))
                                {
                                    ...
                                    Store (MXMB, MXM3) /* \_SB_.PCI0.RP05.PEGP._DSM.MXM3 */
                                    Return (MXM3) /* \_SB_.PCI0.RP05.PEGP._DSM.MXM3 */
                                }
                            }
                        }
                    }
